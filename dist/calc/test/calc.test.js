    ...
    describe("Multi-Gen", function () {
        ...
        (0, helper_1.inGens)(1, 9, function (_a) {
            ...
            test("Immunity (gen ".concat(gen, ")"), function () {
                expect(calculate(Pokemon("Snorlax"), Pokemon("Gengar"), Move("Hyper Beam"))
                    .damage).toBe(0);
            });
        });
        (0, helper_1.inGens)(1, 9, function (_a) {
        ...
        (0, helper_1.inGens)(6, 9, function (_a) {
            ...
            test("Flying Press (gen ".concat(gen, ")"), function () {
                ...
                var ringTargetSpiritomb = Pokemon("Spiritomb", {
                    item: "Ring Target"
                });
        ...
        (0, helper_1.inGens)(5, 9, function (_a) {
            ...
            var dragonite1 = Pokemon("Dragonite", {
                ability: "Multiscale",
                curHP: 69
            });
            var dragonite2 = Pokemon("Dragonite", {
                ability: "Energy Shield",
                item: "Heavy-Duty Boots"
            });
            if (gen > 7) {
                test("Multiscale and Energy Shield halves damage even if there are hazzards if holding Heavy-Duty Boots (gen ".concat(gen, ")"), function () {
                    ...
                    expect(result.desc()).toBe("0 SpA Abomasnow Blizzard vs. 0 HP / 0 SpD Energy Shield Dragonite: 222-264 (68.7 - 81.7%) -- guaranteed 2HKO");
                });
            }
            test("Multiscale and Energy Shield should not halve damage if less than 100% HP (gen ".concat(gen, ")"), function () {
            ...
            test("Multiscale and Energy Shield Should halve damage taken (gen ".concat(gen, ")"), function () {
            ...
            describe("Weight", function () {
                describe("Heavy Metal", function () {
                    ...
                    it("should double the weight of a Pokemon", function () {
                        return expect(testBP("Gluttony")).toBe(80);
                    });
                    it("should be negated by Mold Breaker", function () {
                        return expect(testBP("Mold Breaker")).toBe(60);
                    });
                });
                describe("Light Metal", function () {
                    ...
                    it("should halve the weight of a Pokemon", function () {
                        return expect(testBP("Gluttony")).toBe(100);
                    });
                    it("should be negated by Mold Breaker", function () {
                        return expect(testBP("Mold Breaker")).toBe(120);
                    });
                });
                describe("Float Stone", function () {
                    ...
                    it("should halve the weight of a Pokemon", function () {
                        return expect(testBP()).toBe(100);
                    });
                    it("should stack with Light Metal", function () {
                        return expect(testBP("Light Metal")).toBe(80);
                    });
                });
            });
        });
        ...
        (0, helper_1.inGens)(6, 9, function (_a) {
            var gen = _a.gen, calculate = _a.calculate, Pokemon = _a.Pokemon, Move = _a.Move;
            test("Expertise (gen ".concat(gen, ")"), function () {
                ...
                if (gen === 6) {
                    ...
                    expect(result.desc()).toBe("152 Atk Expertise Kangaskhan-Mega Frustration vs. 252 HP / 152+ Def Amoonguss: 229-270 (53 - 62.5%) -- approx. 2HKO");
                }
                else {
                    expect(result.damage).toEqual([
                        [
                    ...
                    expect(result.desc()).toBe("152 Atk Expertise Kangaskhan-Mega Frustration vs. 252 HP / 152+ Def Amoonguss: 190-225 (43.9 - 52%) -- approx. 6.6% chance to 2HKO");
                }
                result = calculate(Pokemon("Kangaskhan-Mega", { level: 88 }), Pokemon("Amoonguss"), Move("Seismic Toss"));
                expect(result.damage).toEqual([88, 88]);
                expect(result.desc()).toBe("Lvl 88 Expertise Kangaskhan-Mega Seismic Toss vs. 0 HP Amoonguss: 176-176 (47.6 - 47.6%) -- guaranteed 3HKO");
                result = calculate(Pokemon("Kangaskhan-Mega", { evs: { atk: 252 } }), Pokemon("Aggron", { level: 72 }), Move("Power-Up Punch"));
                if (gen === 6) {
                    expect(result.desc()).toBe("252 Atk Expertise Kangaskhan-Mega Power-Up Punch vs. Lvl 72 0 HP / 0 Def Aggron: 248-296 (120.9 - 144.3%) -- guaranteed OHKO");
                }
                else {
                    expect(result.desc()).toBe("252 Atk Expertise Kangaskhan-Mega Power-Up Punch vs. Lvl 72 0 HP / 0 Def Aggron: 196-236 (95.6 - 115.1%) -- 78.9% chance to OHKO");
                }
                if (gen === 6)
                    return;
                ...
                expect(result.desc()).toBe("252 Atk Expertise Kangaskhan-Mega Crunch vs. 0 HP / 0 Def Energy Shield Lunala: 280-334 (67.4 - 80.4%) -- approx. 2HKO");
            });
        });
        (0, helper_1.inGens)(6, 9, function (_a) {
            var gen = _a.gen, calculate = _a.calculate, Pokemon = _a.Pokemon, Move = _a.Move;
            test("Knock Off vs. Klutz", function () {
                ...
                var audino = Pokemon("Audino", {
                    ability: "Klutz",
                    item: "Leftovers"
                });
                var audinoMega = Pokemon("Audino", {
                    ability: "Klutz",
                    item: "Audinite"
                });
    ...
    describe("Gen 7", function () {
        (0, helper_1.inGen)(7, function (_a) {
            ...
            test("Wring Out", function () {
                var smeargle = Pokemon("Smeargle", {
                    level: 50,
                    ability: "Technician"
                });
                var blissey = Pokemon("Blissey", {
                    level: 50,
                    evs: { hp: 252 },
                    curHP: 184
                });
    ...
    describe("Gen 9", function () {
        (0, helper_1.inGen)(9, function (_a) {
            ...
            test("Supreme Overlord", function () {
                var kingambit = Pokemon("Kingambit", {
                    level: 100,
            ...
            function testQP(ability, field) {
                test("".concat(ability, " should take into account boosted stats by default"), function () {
                    var attacker = Pokemon("Iron Leaves", {
                        ability: ability,
                        boostedStat: "auto",
                        boosts: { spa: 6 }
                    });
                    var defender = Pokemon("Iron Treads", {
                        ability: ability,
                        boostedStat: "auto",
                        boosts: { spd: 6 }
                    });
            ...
            function testQPOverride(ability, field) {
                test("".concat(ability, " should be able to be overridden with boostedStat"), function () {
                    var attacker = Pokemon("Flutter Mane", {
                        ability: ability,
                        boostedStat: "atk",
                        boosts: { spa: 6 }
                    });
                    var defender = Pokemon("Walking Wake", {
                        ability: ability,
                        boostedStat: "def",
                        boosts: { spd: 6 }
                    });
            ...
            describe("Tera Stellar", function () {
                ...
                test("should only be displayed on defender for Stellar attacks", function () {
                    expect(calculate(control, terastal, Move("Tera Blast")).rawDesc
                        .defenderTera).toBeUndefined();
                    expect(calculate(terastal, terastal, Move("Tera Blast")).rawDesc
                        .defenderTera).toBeDefined();
                    expect(calculate(terastal, terastal, Move("Tera Blast", { isStellarFirstUse: true })).rawDesc.defenderTera).toBeDefined();
                    expect(calculate(control, terastal, Move("Tera Blast", { isStellarFirstUse: true })).rawDesc.defenderTera).toBeUndefined();
                });
                test("should not be displayed for non-boosted attacks", function () {
                    return expect(calculate(terastal, control, Move("Judgment", { isStellarFirstUse: false })).rawDesc.attackerTera).toBeUndefined();
                });
                test("should distinguish between first use for Tera Blast", function () {
                    var result = [true, false].map(function (isStellarFirstUse) {
                        ...
                        return calculate(terastal, control, Move("Tera Blast", { isStellarFirstUse: isStellarFirstUse })).rawDesc.isStellarFirstUse;
                    });
        ...
        describe("Descriptions", function () {
            (0, helper_1.inGen)(9, function (_a) {
                ...
                test("displayed chances should not round to 100%", function () {
                    var result = calculate(Pokemon("Xerneas", {
                        item: "Choice Band",
                        nature: "Adamant",
                        evs: { atk: 252 }
        ...
        describe("Some moves should break screens before doing damage", function () {
            (0, helper_1.inGens)(3, 9, function (_a) {
                ...
                test("Brick Break should break screens", function () {
                    ...
                    var otherMove = Move("Vital Throw", {
            ...
            (0, helper_1.inGens)(7, 9, function (_a) {
                ...
                test("Psychic Fangs should break screens", function () {
                    ...
                    var otherMove = Move("Zen Headbutt", {
                        overrides: { basePower: 75 }
                    });
                    var field = Field({ defenderSide: { isReflect: true } });
