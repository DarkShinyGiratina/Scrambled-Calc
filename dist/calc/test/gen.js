...
var Move = (function () {
    function Move(move, dex) {
        ...
        if (((_a = move.self) === null || _a === void 0 ? void 0 : _a.boosts) &&
        ...
        if (dex.gen >= 4) {
            if (move.flags.punch)
                this.flags.brazen = move.flags.punch;
            if (move.flags.bite)
...
var Specie = (function () {
    function Specie(species, dex) {
        ...
        var nfe = !!((_a = species.evos) === null || _a === void 0 ? void 0 : _a.some(function (s) {
            return exists(dex.species.get(s), dex.gen);
        }));
        if (nfe)
            this.nfe = nfe;
        if (species.gender === "N" && dex.gen > 1)
            this.gender = species.gender;
        var formes = (_b = species.otherFormes) === null || _b === void 0 ? void 0 : _b.filter(function (s) {
            return exists(dex.species.get(s), dex.gen);
        });
    ...
    function Types(dex) {
        ...
        for (var id in this.dex.data.Types) {
            ...
            for (var t2ID in this.dex.data.Types) {
                ...
                effectiveness[t] =
                    DAMAGE_TAKEN[this.dex.data.Types[t2ID].damageTaken[name_1]];
            }
