...
function calculateSMSSSV(gen, attacker, defender, move, field) {
    ...
    (0, util_2.checkInstinct)(attacker, defender, field.isWonderRoom);
    (0, util_2.checkInstinct)(defender, attacker, field.isWonderRoom);
            ...
            basePower =
                move.bp *
                    (attacker.hasItem("Flying Gem") ||
                        !attacker.item ||
                        (0, util_2.isQPActive)(attacker, field)
                        ? 2
                        : 1);
            desc.moveBP = basePower;
            break;
...
function calculateBPModsSMSSSV(gen, attacker, defender, move, field, desc, basePower, hasAteAbilityTypeChange, turnOrder) {
    ...
    var resistedKnockOffDamage = !defenderItem ||
        (0, util_2.isQPActive)(defender, field) ||
    ...
    else if ((((attacker.hasItem("Adamant Crystal") &&
...
function calculateAtModsSMSSSV(gen, attacker, defender, move, field, desc) {
    ...
    else if (attacker.hasAbility("Brute Force") &&
        move.category === "Physical" &&
        !attacker.isDynamaxed) {
        atMods.push(6144);
        desc.attackerAbility = attacker.ability;
    ...
    else if ((attacker.hasAbility("Liquid Veil") && move.hasType("Water")) ||
...
function calculateDfModsSMSSSV(gen, attacker, defender, move, field, desc, isCritical, hitsPhysical) {
    ...
    else if (defender.hasAbility("Grassy Guard") &&
        field.hasTerrain("Grassy") &&
        hitsPhysical) {
        dfMods.push(6144);
        desc.defenderAbility = defender.ability;
...
function calculateFinalModsSMSSSV(gen, attacker, defender, move, field, desc, isCritical, typeEffectiveness, hitCount) {
    ...
    if (defender.hasAbility("Multiscale", "Energy Shield") &&
        defender.curHP() === defender.maxHP() &&
        hitCount === 0 &&
        ((!field.defenderSide.isSR &&
            (!field.defenderSide.spikes || defender.hasType("Flying"))) ||
    ...
    else if ((defender.hasAbility("Amplifier") && move.flags.sound) ||
        (defender.hasAbility("Permafrost") && move.category === "Special")) {
        finalMods.push(2048);
        desc.defenderAbility = defender.ability;
    }
    if (defender.hasAbility("Solid Rock", "Filter", "Resilient") &&
        typeEffectiveness > 1) {
        finalMods.push(3072);
        desc.defenderAbility = defender.ability;
    }
